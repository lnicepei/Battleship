...
exports.createBoard = exports.randomCoordinate = exports.Gameboard = void 0;
...
function createShips(arrayOfShips) {
    ...
    for (let k = 4; k > 0; k--) {
        for (let i = k; i > 0; i--) {
            ...
            let result = 1;
            while (result) {
                const ship = (0, Ships_1.Ships)(i, horizontalOrVertical(), randomCoordinate(), randomCoordinate());
...
function createBoard(shipsBoard) {
    shipsBoard = [];
    for (let i = 0; i < 10; i++) {
